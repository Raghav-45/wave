...
export const Chat = (props) => {
  ...
  return (
    <Flex my={'22px'} height={'72px'} width={'auto'} rounded={'20px'} bgGradient='linear(to-tr, rgb(252 252 253 / 100%), rgb(252 252 253 / 80%))' boxShadow='0 0 64px 10px rgb(15 15 15 / 10%)'>
